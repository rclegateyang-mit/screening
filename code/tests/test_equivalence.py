...
from screening.analysis.lib.helpers import (
...
from screening.analysis.lib.jax_model import compute_choice_probabilities_jax, enable_x64

# Legacy modules — these were archived; tests depending on them will fail.
# See archive/code_legacy/legacy_estimation/ for the original sources.
try:
    from screening.analysis.lib.g_features import chamberlain_instruments_jax
    from screening.analysis.lib.moments import criterion as criterion_jax
except ImportError:
    chamberlain_instruments_jax = None  # type: ignore
    criterion_jax = None  # type: ignore
