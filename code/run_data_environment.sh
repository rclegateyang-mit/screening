...
run_module screening.simulate.01_prep_data "${PREP_ARGS[@]}"
run_module screening.clean.02_solve_equilibrium "${SOLVE_ARGS[@]}"
run_module screening.clean.02_solve_equilibrium "${NOSCREEN_ARGS[@]}"
run_module screening.build.03_draw_workers ${WORKERS_ARGS[@]+"${WORKERS_ARGS[@]}"}
run_module screening.build.04_compute_markdowns "${MARKDOWN_ARGS[@]}"
